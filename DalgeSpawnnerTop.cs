...
public class DalgeSpawnnerTop : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            spawnDalga();
            dalgaZamaný = dalgaZamaný - (dalgaZamaný / 70);
            dalgaDöngü = 0f;
        }
    }
    void spawnDalga()
    {
        ...
        if (position.x < -6)
        {
            gercekAcý = new Vector3(0, 0, 210);
        }
        else if (position.x >= -6 && position.x <= 7)
        {
            gercekAcý = new Vector3(0, 0, 180);
        }
        else if (position.x > 7)
        {
            gercekAcý = new Vector3(0, 0, 150);
        }
